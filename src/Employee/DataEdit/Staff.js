...
import {Accordion, Button, Form, InputGroup, Modal, Offcanvas, Spinner} from "react-bootstrap";
    ...
    return (
        <Form>
            ...
            <InputGroup className="mb-1">
                <Form.Control placeholder="First name" value={formState.firstName} name="firstName"
                              onChange={handleChange}/>
                <Form.Control placeholder="Last name" value={formState.lastName} name="lastName"
                              onChange={handleChange}/>
            </InputGroup>
            <Form.Text className="mx-1">Email</Form.Text>
            <Form.Control type="email" placeholder="Email address" className="mb-1" value={formState.email} name="email"
                          onChange={handleChange}/>
            <Form.Text className="mx-1">Password</Form.Text>
            <Form.Control type="password" placeholder="Password" className="mb-1" value={formState.password}
            ...
            <Form.Control className="mb-1" placeholder="123-456-7890" value={formState.phoneNumber} name="phoneNumber"
                          onChange={handleChange}/>
            <Form.Text className="mx-1">Address</Form.Text>
            <Form.Control className="mb-1" placeholder="Street, Apt#, City, State, Zip" value={formState.address}
                          name="address" onChange={handleChange}/>
            <Form.Text className="mx-1">Start date</Form.Text>
            <Form.Control type="date" className="mb-1" value={formState.startDate} name="startDate"
                          onChange={handleChange}/>
            <Form.Text className="mx-1">End date</Form.Text>
            <Form.Control type="date" className="mb-1" value={formState.endDate} name="endDate"
                          onChange={handleChange}/>
            <Form.Text className="mx-1">Role</Form.Text>
            <Form.Select aria-label="Employee Role" value={formState.accessLevel} name="accessLevel"
                         onChange={handleChange}>
...
export function EmployeeModalFormContainer() {
    ...
    return (
        ...
        >
            ...
            <Modal.Footer>
                <Button disabled={!(canSubmit && submitEnabled)} onClick={() => {
                    handleSubmit();
