        ...
        <>
            {item && formState && (
                <Form>
                    ...
                    <Form.Control className="mx-0" placeholder="Concession stand name" value={formState.CName}
                                  name="CName" onChange={handleChange}/>
                    ...
                    <InputGroup>
                        <Form.Control className="mx-0" type="number" value={formState.CPriceMin} name="CPriceMin"
                                      onChange={handleChange}/>
                        <Form.Control className="mx-0" type="number" value={formState.CPriceMax} name="CPriceMax"
                                      onChange={handleChange}/>
                    </InputGroup>
                </Form>
            )}
