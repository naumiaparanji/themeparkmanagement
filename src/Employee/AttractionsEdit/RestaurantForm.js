        ...
        <>
            {item && formState && (
                <Form>
                    ...
                    <Form.Control className="mx-0" placeholder="Restaurant name" value={formState.RName} name="RName"
                    ...
                    <Form.Control className="mx-0" type="number" value={formState.SeatingCapacity}
                                  name="SeatingCapacity" onChange={handleChange}/>
                    <Form.Text className="mx-0">Operating Hours</Form.Text>
                    <InputGroup>
                        <Form.Control className="mx-0" type="time" value={formState.OpenInput} name="OpenInput"
                                      onChange={handleChange}/>
                        <Form.Control className="mx-0" type="time" value={formState.CloseInput} name="CloseInput"
                                      onChange={handleChange}/>
                    </InputGroup>
                    <Form.Text className="mx-0">Price Range</Form.Text>
                    <InputGroup>
                        <Form.Control className="mx-0" type="number" value={formState.RPriceMin} name="RPriceMin"
                                      onChange={handleChange}/>
                        <Form.Control className="mx-0" type="number" value={formState.RPriceMax} name="RPriceMax"
                                      onChange={handleChange}/>
                    </InputGroup>
                </Form>
            )}
