        ...
        <>
            {item && formState && (
                <Form>
                    ...
                    <Form.Control className="mx-0" placeholder="Gift shop name" value={formState.GName} name="GName"
                    ...
                    <InputGroup>
                        <Form.Control className="mx-0" type="number" value={formState.GPriceMin} name="GPriceMin"
                                      onChange={handleChange}/>
                        <Form.Control className="mx-0" type="number" value={formState.GPriceMax} name="GPriceMax"
                                      onChange={handleChange}/>
                    </InputGroup>
                </Form>
            )}
