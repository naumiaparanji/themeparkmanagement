    ...
    return (
        <div>
            ...
            <div className="attractions-container">
                ...
                <br></br>
                <block id="topquote_one"><p><b>Take a look at our many attractions ranging from Restaurants, Gift Shops,
                    and even Concession Stands!</b></p></block>
                        ...
                        <div className="attractions-list">
                            {attractions.filter(attractions => attractions.Category === category).map(attraction => (
                                <div className="attractions-card" key={attraction.ID}>
                                    ...
                                    <p><strong><u>Price
                                        Range:</u></strong> {`$${attraction.PriceMin} - $${attraction.PriceMax}`}</p>
                                </div>
                            ))}
                        </div>
                    </div>
